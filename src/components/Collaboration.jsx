      ...
      <div className="container lg:flex">
        ...
        <div className="lg:ml-auto xl:w-[38rem] mt-4">
          ...
          <div className="relative left-1/2 flex w-[22rem] aspect-square border border-n-4 rounded-full -translate-x-1/2 scale:75 md:scale-100">
            <div className="flex w-60 aspect-square m-auto border border-n-4 rounded-full">
            ...
            <ul>
              ...
              {collabApps.map((app, index) => (
                ...
                >
                  <div
                    className={`relative -top-[1.6rem] flex w-[3.2rem] h-[3.2rem] bg-n-7 border border-n-1 rounded-xl -rotate-${
                      index * 45
                    }`}
                  >
                    <img
