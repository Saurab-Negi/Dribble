...
import {navigation} from "../constants/index" //Drop down navigation menu 
...
//JavaScript library to disable scrolling page when the drop down navigation menu is on
      ...
      >
        <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
          <a className="block w-[12rem] xl:mr-8" href="#hero">
            <img src={brainwave} width={190} height={40} alt="TalkBot" />
          </a>
